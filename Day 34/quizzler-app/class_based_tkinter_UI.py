...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        # Creating the window
        # Make it to a property of the class instead of just a simple variable
        self.window = Tk()
        ...
        self.question_text = self.canvas.create_text(150, 125, width=280, text="Hello", fill=THEME_COLOR,
